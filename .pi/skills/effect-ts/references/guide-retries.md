...
- `./.agent_sources/effect/packages/effect/src/Schedule.ts`
- `./.agent_sources/effect/packages/effect/src/ExecutionPlan.ts`
- `./.agent_sources/effect/packages/effect/test/Effect.test.ts`
- `./.agent_sources/effect/packages/effect/test/ExecutionPlan.test.ts`

Representative repo usage:

- `./.agent_sources/effect/packages/effect/src/unstable/workflow/Activity.ts`
- `./.agent_sources/effect/packages/effect/src/unstable/workflow/WorkflowEngine.ts`
- `./.agent_sources/effect/packages/effect/src/unstable/rpc/RpcClient.ts`
- `./.agent_sources/effect/packages/effect/src/unstable/observability/OtlpExporter.ts`
- `./.agent_sources/effect/packages/vitest/src/internal/internal.ts`
