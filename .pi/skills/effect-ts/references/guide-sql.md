...
This guide is based on the vendored Effect SQL modules in `./.agent_sources/effect`.

Key source files:

- `./.agent_sources/effect/packages/effect/src/unstable/sql/SqlClient.ts`
- `./.agent_sources/effect/packages/effect/src/unstable/sql/Migrator.ts`
- `./.agent_sources/effect/packages/effect/src/unstable/sql/SqlResolver.ts`
- `./.agent_sources/effect/packages/effect/src/unstable/sql/SqlSchema.ts`
- `./.agent_sources/effect/packages/effect/src/unstable/sql/SqlModel.ts`
