...
This guide is based on the vendored `Schedule` module and its usage across `./.agent_sources/effect`.

Key source files:

- `./.agent_sources/effect/packages/effect/src/Schedule.ts`
- `./.agent_sources/effect/packages/effect/test/Schedule.test.ts`
