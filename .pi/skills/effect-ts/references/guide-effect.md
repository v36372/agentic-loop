...
This guide is based on common usage patterns in the vendored repo at `./.agent_sources/effect`.

Key source areas:

- `./.agent_sources/effect/packages/effect/src/Effect.ts`
- `./.agent_sources/effect/packages/tools/`
- `./.agent_sources/effect/packages/platform-*`
- `./.agent_sources/effect/packages/opentelemetry/`
- `./.agent_sources/effect/packages/vitest/`
...
- `./.agent_sources/effect/packages/tools/utils/src/Codegen.ts`
- `./.agent_sources/effect/packages/tools/openapi-generator/src/OpenApiPatch.ts`
...
- `./.agent_sources/effect/packages/opentelemetry/src/NodeSdk.ts`
- `./.agent_sources/effect/packages/tools/openapi-generator/src/OpenApiGenerator.ts`
...
- `./.agent_sources/effect/packages/tools/utils/src/bin.ts`
- `./.agent_sources/effect/packages/tools/openapi-generator/test/`
...
- `./.agent_sources/effect/packages/platform-node/`
- `./.agent_sources/effect/packages/opentelemetry/src/NodeSdk.ts`
...
- `./.agent_sources/effect/packages/tools/openapi-generator/src/OpenApiGenerator.ts`
- `./.agent_sources/effect/packages/opentelemetry/src/NodeSdk.ts`
- `./.agent_sources/effect/packages/opentelemetry/src/Tracer.ts`
- `./.agent_sources/effect/packages/platform-node/`
- `./.agent_sources/effect/packages/vitest/src/index.ts`
