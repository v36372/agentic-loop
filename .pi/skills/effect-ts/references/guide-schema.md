...
This guide is based on the vendored Schema module and common repo usage in `./.agent_sources/effect`.

Key source files:

- `./.agent_sources/effect/packages/effect/src/Schema.ts`
- `./.agent_sources/effect/packages/effect/src/SchemaTransformation.ts`
- `./.agent_sources/effect/packages/effect/src/SchemaGetter.ts`
- `./.agent_sources/effect/packages/effect/src/SchemaIssue.ts`
- `./.agent_sources/effect/packages/effect/src/JsonSchema.ts`

Representative repo usage:

- `./.agent_sources/effect/packages/tools/ai-codegen/src/Config.ts`
- `./.agent_sources/effect/packages/platform-node/test/fixtures/rpc-schemas.ts`
- `./.agent_sources/effect/packages/platform-browser/test/IndexedDbQueryBuilder.test.ts`
- `./.agent_sources/effect/packages/tools/openapi-generator/`
...
- `./.agent_sources/effect/packages/platform-node/test/fixtures/rpc-schemas.ts`
- `./.agent_sources/effect/packages/platform-browser/test/IndexedDbQueryBuilder.test.ts`
- `./.agent_sources/effect/packages/tools/openapi-generator/src/JsonSchemaGenerator.ts`
- `./.agent_sources/effect/packages/effect/src/Schema.ts`
