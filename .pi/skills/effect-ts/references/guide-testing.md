...
This guide is based on the vendored `@effect/vitest` package in `./.agent_sources/effect`.

Key source files:

- `./.agent_sources/effect/packages/vitest/src/index.ts`
- `./.agent_sources/effect/packages/vitest/src/internal/internal.ts`
- `./.agent_sources/effect/packages/vitest/test/index.test.ts`
- `./.agent_sources/effect/packages/vitest/typetest/index.tst.ts`
