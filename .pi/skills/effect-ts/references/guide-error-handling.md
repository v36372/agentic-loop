...
This guide is based on the vendored Effect source in `./.agent_sources/effect`.

Key source files:

- `./.agent_sources/effect/packages/effect/src/Data.ts`
- `./.agent_sources/effect/packages/effect/src/Schema.ts`
- `./.agent_sources/effect/packages/effect/src/Cause.ts`
- `./.agent_sources/effect/packages/effect/src/Effect.ts`
- `./.agent_sources/effect/packages/effect/src/unstable/sql/SqlError.ts`
...
- `./.agent_sources/effect/packages/effect/src/Schema.ts`
- examples across `./.agent_sources/effect/packages/effect/src/unstable/*`

Example shape from the vendored repo:

- `./.agent_sources/effect/packages/effect/src/unstable/httpapi/HttpApiError.ts`
- `./.agent_sources/effect/packages/effect/src/unstable/workers/WorkerError.ts`
...
- `./.agent_sources/effect/packages/effect/src/unstable/sql/SqlError.ts`
- `./.agent_sources/effect/packages/effect/src/unstable/socket/Socket.ts`
- `./.agent_sources/effect/packages/effect/src/unstable/eventlog/EventLogMessage.ts`
...
- `./.agent_sources/effect/packages/effect/src/unstable/sql/SqlError.ts`
- `./.agent_sources/effect/packages/effect/src/unstable/rpc/RpcClientError.ts`
- `./.agent_sources/effect/packages/effect/src/unstable/socket/Socket.ts`
- `./.agent_sources/effect/packages/effect/src/unstable/workers/WorkerError.ts`
- `./.agent_sources/effect/packages/effect/src/unstable/persistence/Redis.ts`
...
- `./.agent_sources/effect/packages/effect/src/Schema.ts`
- `./.agent_sources/effect/packages/effect/src/unstable/sql/SqlError.ts`
- `./.agent_sources/effect/packages/effect/src/unstable/http/HttpClientError.ts`
- `./.agent_sources/effect/packages/effect/src/unstable/http/HttpServerError.ts`
- `./.agent_sources/effect/packages/effect/src/unstable/socket/Socket.ts`
- `./.agent_sources/effect/packages/effect/src/unstable/httpapi/HttpApiError.ts`
